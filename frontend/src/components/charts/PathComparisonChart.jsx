...
export default function PathComparisonChart({ paths }) {
  ...
  const renderXAxisTick = (props) => {
    ...
    return (
      <text x={x} y={y + 12} textAnchor="middle" fill="#a8a29e" fontSize={10} fontFamily="Inter">
  ...
  return (
    <div className="chart-container">
      ...
      <ResponsiveContainer width="100%" height={280}>
        <BarChart data={data} barCategoryGap="30%" margin={{ top: 20, right: 10, left: -20, bottom: 20 }}>
          <CartesianGrid strokeDasharray="2 4" stroke="rgba(255,255,255,0.04)" vertical={false} />
          <XAxis dataKey="name" tick={renderXAxisTick} axisLine={false} tickLine={false} />
